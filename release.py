...
# -----------------------------------------------------------------------------
CONFIG = {
    "package_name": "ai-interactor",
    "package_directory": "interactor",
    "version_module": "interactor/__version__.py",
    "readme": "README.md",
    "license": "LICENSE",
    ...
    "project_url": "https://github.com/woodyk/interactor",
...
def main(dry_run=False):
    ...
    run(f"{python} -m pdoc -d markdown -o {CONFIG['docs_output']} {CONFIG['package_directory']}", "docs")
